...
local function PCTYAP_fake_script() -- ImageButton.LocalScript 
...
coroutine.wrap(PCTYAP_fake_script)()
local function TINARWG_fake_script() -- ImageButton.LocalScript 
	local script = Instance.new('LocalScript', ImageButton)
...
coroutine.wrap(TINARWG_fake_script)()
